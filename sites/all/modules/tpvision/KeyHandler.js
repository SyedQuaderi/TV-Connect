...
$(document).keydown(function(e) {
 ...
 function keyDownHandler(e) {  
  ...
  //$('.link.wobj').blur();
  //$('.page-active .link.wobj.active').focus();
...
function changegadgethtmlobject() {
 ...
 //Load external twiiter js
 if ($('.twitter-timeline').length > 0 || $('.twitter-grid').length > 0) {
    $.getScript("http://platform.twitter.com/widgets.js");
 }
    $.getScript("http://lightwidget.com/widgets/lightwidget.js");
}
